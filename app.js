  ...
  itemDetailEdit.innerHTML = `
    ...
    <div class="photo-uploader ${state.editExtractedImage ? "is-extracted" : ""}" id="editPhotoUploader" style="position: relative;">
      <div class="extracted-object ${state.editExtractedImage ? "has-image" : ""}" id="editExtractedObject">
        ${state.editExtractedImage ? `<img src="${state.editExtractedImage}" alt="Extracted item preview" />` : `<img src="Image.png" class="uploader-placeholder-img" alt="Placeholder" />`}
      </div>
...
function openAddSheet() {
  ...
  extractedObject.innerHTML = `<img src="Image.png" class="uploader-placeholder-img" alt="Placeholder" />`;
